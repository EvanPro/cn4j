package com.evan.cn4j.system.controller;
...
import com.evan.cn4j.common.core.web.PageSolver;
import com.evan.cn4j.common.core.web.controller.BaseController;
import com.evan.cn4j.common.security.annotation.PreAuthorize;
import com.evan.cn4j.common.security.utils.SecurityUtils;
...
public class SysMessageController extends BaseController {
    ...
    public R<SysMessage> publishToAdmin(@RequestBody SysMessage sysMessage) {
        sysMessageService.publishToAdmin(sysMessage);
        return R.ok();
    }
    ...
    public R<SysMessage> publishDept(@PathVariable("deptId") Long deptId, @RequestBody SysMessage sysMessage) {
